...
gulp.task('replacePath', function(){
    var replacePath2 = gulp.src(['./pages/*.html'], { base: "./" })
        ...
        .pipe(replace('href="base.html"', 'href="../base.html"'))
        .pipe(gulp.dest('.'));
    var replacePath3 = gulp.src(['./base.html'], { base: "./" })
        .pipe(replace('="images/', '="images/'))
        .pipe(gulp.dest('.'));
...
/*Building vendor scripts needed for basic staff_site rendering*/
...
/*Building vendor styles needed for basic staff_site rendering*/
